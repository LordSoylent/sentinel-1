...
class GovernanceClass(object):
    ...
    def list(self):
        ...
        # return a dict similar to suncoind "gobject list" output
    ...
    def suncoind_serialise(self):
        import suncoinlib
        return suncoinlib.SHIM_serialise_for_suncoind(self.serialise())
