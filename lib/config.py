...
sentinel_cfg = SunCoinConfig.tokenize(sentinel_config_file)
sentinel_version = "1.1.0"
min_suncoind_proto_version_with_sentinel_ping = 70207


def get_suncoin_conf():
    home = os.environ.get('HOME')

    suncoin_conf = os.path.join(home, ".suncoincore/suncoin.conf")
    if sys.platform == 'darwin':
        suncoin_conf = os.path.join(home, "Library/Application Support/SunCoinCore/suncoin.conf")

    suncoin_conf = sentinel_cfg.get('suncoin_conf', suncoin_conf)
